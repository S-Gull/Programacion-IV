""" 
Programa que almacena esta información de los libros:
Título, Autor
Año, ISBN
...
b3=Button(window,text="Agregar", width=12,command=add_command)
b3.grid(row=4,column=3)

b4=Button(window,text="Modificar", width=12,command=update_command)
